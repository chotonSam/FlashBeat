      ...
      <div className="container mx-auto">
        <div className="xl:grid xl:grid-cols-12 xl:gap-8">
          <div className="grid grid-cols-2 gap-8 md:grid md:grid-cols-2 md:gap-8 lg:grid-cols-3 xl:col-span-7 xl:grid-cols-5">
            {/* logo start  */}
            <div class=" flex items-start space-x-1 text-white font-semibold">
              <div class="bg-yellow-400 p-1 rounded-full">
                ...
                >
                  <path d="M13 2L9 14h6l-4 8L15 22l4-14h-6z"></path>
                </svg>
              </div>

              <span class="text-2xl font-extrabold text-white">FlashBeat</span>
            </div>
          ...
          <div className="col-span-12 mt-10 flex items-start gap-4 xl:col-span-5 xl:mt-0">
            ...
            {/* <!-- subscribe --> */}
            <button className="roundedFull bg-[#00D991] px-7 py-2.5 text-xs font-medium text-[#F1EFEA] hover:opacity-80 lg:text-base">
              Subscribe
            </button>
          </div>
        </div>
